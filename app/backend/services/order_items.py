...
class Order_itemsService:
    ...
    async def create(self, data: Dict[str, Any]) -> Optional[Order_items]:
    ...
    async def get_by_id(self, obj_id: int) -> Optional[Order_items]:
    ...
    async def get_list(
        ...
        """Get paginated list of order_itemss"""
        try:
    ...
    async def update(self, obj_id: int, update_data: Dict[str, Any]) -> Optional[Order_items]:
        """Update order_items"""
        try:
